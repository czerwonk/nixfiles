{
  ...
  inputs = {
    ...
    mcp-hub.url = "github:ravitemer/mcp-hub?ref=b8e7d1c80ccf7e2b81eb234b90becb535efff820";
    mcphub-nvim.url = "github:ravitemer/mcphub.nvim?ref=72109843e29b9cf3ab663a799934bb498518bf00";
  };
