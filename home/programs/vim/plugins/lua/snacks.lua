...
vim.keymap.set('n', '<leader>fh', function() Snacks.picker.cliphist() end, { desc = 'Clip History' })
...
vim.keymap.set('n', '<leader>fs', function() Snacks.picker.git_log() end, { desc = 'Git Commits' })
